...
#from get_class_amplitude_data import process_file
from prepro_amplitude_chunk import process_file
...
def get_classdata(selected_classes):
    ...
    for class_id_num in selected_classes:
        ...
        dfconcat = process_file(file_paths, class_id_num)
    ...
    old_data =pd.read_csv('../csv/data_original.csv')
...
def train(df):
    ...
    # Save model
    joblib.dump(clf, 'model20230327.joblib')
